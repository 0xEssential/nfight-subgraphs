...
export class NFightUpgradeableChild__getFighterResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class NFightUpgradeableChild__nFightersResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class NFightUpgradeableChild__playersResult {
  value0: i32;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class NFightUpgradeableChild__tokenOfOwnerByIndexResultValue0Struct extends ethereum.Tuple {
  get contractAddress(): Address {
...
export class NFightUpgradeableChild extends ethereum.SmartContract {
  static bind(address: Address): NFightUpgradeableChild {
    return new NFightUpgradeableChild("NFightUpgradeableChild", address);
  }
  ...
  getFighter(
    ...
    _tokenId: BigInt
  ): NFightUpgradeableChild__getFighterResult {
    let result = super.call(
      "getFighter",
    ...
    return new NFightUpgradeableChild__getFighterResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_getFighter(
    mainnetContract: Address,
    _tokenId: BigInt
  ): ethereum.CallResult<NFightUpgradeableChild__getFighterResult> {
    let result = super.tryCall(
      "getFighter",
      "getFighter(address,uint256):(uint256,uint256,uint256,uint256,uint256,uint256)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new NFightUpgradeableChild__getFighterResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  nFighters(
    param0: Address,
    param1: BigInt
  ): NFightUpgradeableChild__nFightersResult {
    let result = super.call(
      "nFighters",
    ...
    return new NFightUpgradeableChild__nFightersResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_nFighters(
    param0: Address,
    param1: BigInt
  ): ethereum.CallResult<NFightUpgradeableChild__nFightersResult> {
    let result = super.tryCall(
      "nFighters",
      "nFighters(address,uint256):(uint256,uint256,uint256,uint256,uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new NFightUpgradeableChild__nFightersResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  players(param0: Address): NFightUpgradeableChild__playersResult {
    let result = super.call(
      "players",
    ...
    return new NFightUpgradeableChild__playersResult(
      result[0].toI32(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_players(
    param0: Address
  ): ethereum.CallResult<NFightUpgradeableChild__playersResult> {
    let result = super.tryCall(
      "players",
      "players(address):(uint8,uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new NFightUpgradeableChild__playersResult(
        value[0].toI32(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt()
  ...
  tokenOfOwnerByIndex(
    owner: Address,
    index: BigInt
  ): NFightUpgradeableChild__tokenOfOwnerByIndexResultValue0Struct {
    let result = super.call(
      "tokenOfOwnerByIndex",
  ...
  > {
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<NFightUpgradeableChild__tokenOfOwnerByIndexResultValue0Struct>(
        value[0].toTuple()
      )
    );
  }
...
export class RegisterPolygonNFTCall extends ethereum.Call {
  get inputs(): RegisterPolygonNFTCall__Inputs {
    return new RegisterPolygonNFTCall__Inputs(this);
  }

  get outputs(): RegisterPolygonNFTCall__Outputs {
    return new RegisterPolygonNFTCall__Outputs(this);
  }
}

export class RegisterPolygonNFTCall__Inputs {
  _call: RegisterPolygonNFTCall;

  constructor(call: RegisterPolygonNFTCall) {
    this._call = call;
  }
...
export class RegisterPolygonNFTCall__Outputs {
  _call: RegisterPolygonNFTCall;
...
export class RegisterPolygonProjectCall extends ethereum.Call {
  get inputs(): RegisterPolygonProjectCall__Inputs {
    return new RegisterPolygonProjectCall__Inputs(this);
  }

  get outputs(): RegisterPolygonProjectCall__Outputs {
    return new RegisterPolygonProjectCall__Outputs(this);
  }
}

export class RegisterPolygonProjectCall__Inputs {
  _call: RegisterPolygonProjectCall;

  constructor(call: RegisterPolygonProjectCall) {
    this._call = call;
  }
...
export class RegisterPolygonProjectCall__Outputs {
  _call: RegisterPolygonProjectCall;
